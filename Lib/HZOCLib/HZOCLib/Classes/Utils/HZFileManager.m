...
+(NSString *)nc_name:(NSString *)name{
    NSString * path = [self documentsDir];
    return [path stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.nc",name]];
}
