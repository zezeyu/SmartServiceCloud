...
- (void)didInitialize {
    [super didInitialize];
    Class QMUIConfigurationTemplate = NSClassFromString(@"QMUIConfigurationTemplate");
    Class QMUIConfigurationTemplateGrapefruit = NSClassFromString(@"QMUIConfigurationTemplateGrapefruit");
    Class QMUIConfigurationTemplatePinkRose = NSClassFromString(@"QMUIConfigurationTemplatePinkRose");
    Class QMUIConfigurationTemplateDark = NSClassFromString(@"QMUIConfigurationTemplateDark");
    Class QMUIConfigurationTemplateGrass = NSClassFromString(@"QMUIConfigurationTemplateGrass");
    self.classes = @[
